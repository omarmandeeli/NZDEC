...
$n_p_type = $result1['payment_type'];
    ...
    $o_sql = "INSERT INTO billing (order_id, TotalPrice) VALUES ('$o_id', '$p_amount')";
    ...
    $proof_sql = "INSERT INTO proof_payment (acct_no, amount, image_reciept, payment_date, transaction_no, custact_id, order_id, payment_id, event_id) VALUES ('$acc_num', '$p_amount', '$image', '$date', '$r_num', '$c_id', '$o_id', '$p_type', '$n_id')";
...
echo "</tr>";
echo "<tr>"; 
echo '<td> <img src="data:image/jpeg;base64,'.base64_encode($record['image'] ).'" height="200" width="200" class="img-thumnail" /> </td> ';
